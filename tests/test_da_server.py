...
from ansibug import _da_server as das
...
def test_attach_address_port_tls(
    ...
    actual = das.AttachArguments.from_json(args)
    assert actual.get_connection_tuple() == ("addr", 1, expected)
...
def test_launch_console(
    ...
    actual = das.LaunchArguments.from_json(args)
